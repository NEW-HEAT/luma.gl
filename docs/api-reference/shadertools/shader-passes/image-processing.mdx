...
- `start` [x, y] coordinate of the start of the line segment. `[0, 0]` is the bottom left corner, `[1, 1]` is the upper right corner. Default value is `[0, 0]`.
- `end` [x, y] coordinate of the end of the line segment. `[0, 0]` is the bottom left corner, `[1, 1]` is the upper right corner. Default value is `[1, 1]`.
...
- `center` [x, y] coordinate of the blur origin. `[0, 0]` is the bottom left corner, `[1, 1]` is the upper right corner. Default value is `[0.5, 0.5]`.
...
- `center` [x, y] coordinate of the pattern origin. `[0, 0]` is the bottom left corner, `[1, 1]` is the upper right corner. Default value is `[0.5, 0.5]`.
...
- `center` [x, y] coordinate of the pattern center. `[0, 0]` is the bottom left corner, `[1, 1]` is the upper right corner. Default value is `[0.5, 0.5]`.
...
- `center` [x, y] coordinate of the center of the circle of effect. `[0, 0]` is the bottom left corner, `[1, 1]` is the upper right corner. Default value is `[0.5, 0.5]`.
...
- `center` [x, y] coordinate of the center of the circular region. `[0, 0]` is the bottom left corner, `[1, 1]` is the upper right corner. Default value is `[0.5, 0.5]`.
...
- `screenXY`: x, y position in screen coords, both x and y is normalized and in range `[0, 1]`. `[0, 0]` is the upper left corner, `[1, 1]` is the bottom right corner. Default value is `[0, 0]`.
...
- Coordinate is based on the original image. `[0, 0]` is the bottom left corner, `[1, 1]` is the upper right corner.
