...
Note that even though a GPU supports creating and sampling textures of a certain format, additional capabilities may need to be checked separately, more information below the table.
...
| `r16unorm`                            | <Ft f="r16unorm" />                 | <L f="r16unorm" />                 | <R f="r16unorm-webgl" />           | `GL.R16_EXT` `EXT_texture_norm16`                                                                                       |
| `r16snorm`                            | <Ft f="r16snorm" />                 | <L f="r16snorm" />                 | <R f="r16snorm-webgl" />           | `GL.R16_SNORM_EXT` `EXT_texture_norm16`                                                                                 |
...
| `rg16unorm`                           | <Ft f="rg16unorm" />                | <L f="rg16unorm" />                | <R f="rg16unorm" />                |                                                                                                                         |
| `rg16snorm`                           | <Ft f="rg16snorm" />                | <L f="rg16snorm" />                | <R f="rg16snorm-webgl" />          |                                                                                                                         |
...
| `rgba16unorm`                         | <Ft f="rgba16unorm" />              | <L f="rgba16unorm" />              | <R f="rgba16unorm" />              |                                                                                                                         |
| `rgba16snorm`                         | <Ft f="rgba16snorm" />              | <L f="rgba16snorm" />              | <R f="rgba16snorm" />              |                                                                                                                         |
...
| `depth24plus-stencil8`                | <Ft f="depth24plus-stencil8" />     | <L f="depth24plus-stencil8" />     | <R f="depth24plus-stencil8" />     | Platform dependent: Maps to "`depth24unorm`" or `depth32float`.                                                         |
...
You can use `device.isTextureFormatSupported(format)` to check if it is possible to create and sample textures with a specific texture format on your current device.
...
| `GL.RG8UI`                  | 2     | 16 bits  | red and green components, `usampler`, no filtering                                            |
...
| `GL.SRGB_ALPHA8` (EXT_sRGB) | 4     | 32 bits  | Color values are encoded to/decoded from sRGB before being written to/read from framebuffer   |
| `GL.RGB5_A1`                | 4     | 16 bits  | 5 bit RGB, 1 bit alpha                                                                        |
| `GL.RGBA4444`               | 4     | 16 bits  | 4 bit RGBA                                                                                    |
| `GL.RGBA16F`                | 4     | 64 bits  | half float RGBA                                                                               |
| `GL.RGBA32F`                | 4     | 128 bits | float RGBA                                                                                    |
